...
$shengfenzhenghaoma=$_POST['shengfenzhenghaoma'];
//$arr=$_POST;
//$i=0;
...
$result=mysqli_query($con,"SELECT * FROM students2019 WHERE Id=$shengfenzhenghaoma");
...
if($_POST["shengfenzhenghaoma"]!=$Personalid){ 
